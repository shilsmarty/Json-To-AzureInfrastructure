...
Param(
    ...
    [string] $ResourceGroupName = 'InfraTemplates',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'azuredeploy.json',
    [string] $TemplateParametersFile = 'azuredeploy.parameters',
    [string] $ArtifactStagingDirectory = '.',
    [string] $DSCSourceFolder = 'DSC',
	[string] $ResourceType = 'Storage',
...
$TemplateFile = 'Templates\'+$ResourceType+ '\azuredeploy.json'
$TemplateParametersFile = 'Templates\' + $ResourceType + '\azuredeploy.parameters.json'
